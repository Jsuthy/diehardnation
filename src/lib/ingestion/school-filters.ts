...
export const SCHOOL_FILTERS: Record<string, SchoolFilter> = {
  ...
  'usc': {
    required: ['usc trojans', 'usc football', 'usc basketball', 'usc shirt',
      'usc hoodie', 'usc gear', 'southern cal', 'southern california',
      'fight on usc', 'usc cardinal'],
    excluded: ['troy ', 'gaithersburg', 'adelaide', 'nfhs',
      'high school', 'youth league', 'little league',
      'michigan state', 'arkansas state', 'arizona state',
      'florida state', 'mississippi state', 'ohio state',
      'penn state', 'kansas state', 'iowa state'],
  },
  'georgia': {
    required: ['georgia bulldogs', 'georgia football', 'georgia basketball',
      'uga bulldogs', 'uga football', 'go dawgs', 'dawgs georgia',
      'university of georgia'],
    excluded: ['georgia tech', 'georgia state', 'georgia southern',
      'mississippi state', 'fresno state', 'high school'],
  },
  'georgia-tech': {
  ...
  'alabama': {
    required: ['alabama crimson', 'crimson tide', 'roll tide', 'bama football',
      'bama basketball', 'alabama football', 'alabama basketball',
      'university of alabama', 'alabama gear'],
  ...
  'lsu': {
    required: ['lsu', 'louisiana state', 'geaux tigers', 'lsu tigers'],
    excluded: ['missouri', 'memphis', 'auburn', 'clemson',
      'pacific', 'high school', 'save the tigers'],
  },
  'auburn': {
    required: ['auburn tigers', 'auburn football', 'auburn basketball',
      'war eagle', 'auburn university', 'auburn gear'],
    excluded: ['lsu', 'missouri', 'memphis', 'clemson', 'high school'],
  },
  'clemson': {
    required: ['clemson tigers', 'clemson football', 'clemson basketball',
      'clemson university', 'clemson gear'],
    excluded: ['lsu', 'missouri', 'memphis', 'auburn', 'high school'],
  },
  'missouri': {
    required: ['missouri tigers', 'mizzou', 'missouri football',
      'missouri basketball', 'university of missouri'],
    excluded: ['lsu', 'memphis', 'auburn', 'clemson', 'high school'],
  },
  'oregon': {
  ...
  'tennessee': {
    required: ['tennessee volunteers', 'tennessee vols', 'tennessee football',
      'tennessee basketball', 'rocky top', 'university of tennessee',
      'go vols'],
