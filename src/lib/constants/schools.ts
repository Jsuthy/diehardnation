...
export const SCHOOLS: SchoolData[] = [
  ...
  // TOP 20 (by fan size)
  // ═══════════════════════════════════════════
  { slug: 'nebraska', name: 'Nebraska Cornhuskers', short_name: 'Nebraska', mascot: 'Cornhuskers', nickname: 'Huskers', city: 'Lincoln', state: 'NE', conference: 'big-ten', primary_color: '#D11F3A', secondary_color: '#0A0A0A', fan_size_rank: 1 },
  { slug: 'alabama', name: 'Alabama Crimson Tide', short_name: 'Alabama', mascot: 'Crimson Tide', nickname: 'Bama', city: 'Tuscaloosa', state: 'AL', conference: 'sec', primary_color: '#9E1B32', secondary_color: '#FFFFFF', fan_size_rank: 2 },
  { slug: 'ohio-state', name: 'Ohio State Buckeyes', short_name: 'Ohio State', mascot: 'Buckeyes', nickname: 'Bucks', city: 'Columbus', state: 'OH', conference: 'big-ten', primary_color: '#BB0000', secondary_color: '#FFFFFF', fan_size_rank: 3 },
  { slug: 'michigan', name: 'Michigan Wolverines', short_name: 'Michigan', mascot: 'Wolverines', nickname: 'Wolverines', city: 'Ann Arbor', state: 'MI', conference: 'big-ten', primary_color: '#FFCB05', secondary_color: '#00274C', fan_size_rank: 4 },
  ...
  { slug: 'georgia', name: 'Georgia Bulldogs', short_name: 'Georgia', mascot: 'Bulldogs', nickname: 'Dawgs', city: 'Athens', state: 'GA', conference: 'sec', primary_color: '#BA0C2F', secondary_color: '#FFFFFF', fan_size_rank: 6 },
  ...
  { slug: 'oklahoma', name: 'Oklahoma Sooners', short_name: 'Oklahoma', mascot: 'Sooners', nickname: 'Sooners', city: 'Norman', state: 'OK', conference: 'sec', primary_color: '#841617', secondary_color: '#FFFFFF', fan_size_rank: 11 },
  ...
  // SEC (remaining)
  // ═══════════════════════════════════════════
  { slug: 'arkansas', name: 'Arkansas Razorbacks', short_name: 'Arkansas', mascot: 'Razorbacks', nickname: 'Hogs', city: 'Fayetteville', state: 'AR', conference: 'sec', primary_color: '#9D2235', secondary_color: '#FFFFFF', fan_size_rank: 21 },
  ...
  { slug: 'ole-miss', name: 'Ole Miss Rebels', short_name: 'Ole Miss', mascot: 'Rebels', nickname: 'Rebels', city: 'Oxford', state: 'MS', conference: 'sec', primary_color: '#CE1126', secondary_color: '#14213D', fan_size_rank: 23 },
  ...
  // BIG TEN (remaining)
  // ═══════════════════════════════════════════
  { slug: 'minnesota', name: 'Minnesota Golden Gophers', short_name: 'Minnesota', mascot: 'Golden Gophers', nickname: 'Gophers', city: 'Minneapolis', state: 'MN', conference: 'big-ten', primary_color: '#7A0019', secondary_color: '#FFCC33', fan_size_rank: 28 },
  ...
  { slug: 'rutgers', name: 'Rutgers Scarlet Knights', short_name: 'Rutgers', mascot: 'Scarlet Knights', nickname: 'Knights', city: 'Piscataway', state: 'NJ', conference: 'big-ten', primary_color: '#CC0033', secondary_color: '#FFFFFF', fan_size_rank: 35 },
  ...
  // BIG 12 (remaining)
  // ═══════════════════════════════════════════
  { slug: 'oklahoma-state', name: 'Oklahoma State Cowboys', short_name: 'Oklahoma State', mascot: 'Cowboys', nickname: 'Pokes', city: 'Stillwater', state: 'OK', conference: 'big-12', primary_color: '#FF7300', secondary_color: '#000000', fan_size_rank: 38 },
  ...
  { slug: 'kansas', name: 'Kansas Jayhawks', short_name: 'Kansas', mascot: 'Jayhawks', nickname: 'Jayhawks', city: 'Lawrence', state: 'KS', conference: 'big-12', primary_color: '#0051BA', secondary_color: '#E8000D', fan_size_rank: 41 },
  ...
  { slug: 'tcu', name: 'TCU Horned Frogs', short_name: 'TCU', mascot: 'Horned Frogs', nickname: 'Frogs', city: 'Fort Worth', state: 'TX', conference: 'big-12', primary_color: '#4D1979', secondary_color: '#FFFFFF', fan_size_rank: 43 },
  ...
  { slug: 'utah', name: 'Utah Utes', short_name: 'Utah', mascot: 'Utes', nickname: 'Utes', city: 'Salt Lake City', state: 'UT', conference: 'big-12', primary_color: '#CC0000', secondary_color: '#FFFFFF', fan_size_rank: 47 },
  ...
  { slug: 'ucf', name: 'UCF Knights', short_name: 'UCF', mascot: 'Knights', nickname: 'Knights', city: 'Orlando', state: 'FL', conference: 'big-12', primary_color: '#BA9B37', secondary_color: '#000000', fan_size_rank: 52 },
  ...
  { slug: 'miami', name: 'Miami Hurricanes', short_name: 'Miami', mascot: 'Hurricanes', nickname: 'Canes', city: 'Coral Gables', state: 'FL', conference: 'acc', primary_color: '#F47321', secondary_color: '#005030', fan_size_rank: 54 },
  { slug: 'north-carolina', name: 'North Carolina Tar Heels', short_name: 'UNC', mascot: 'Tar Heels', nickname: 'Heels', city: 'Chapel Hill', state: 'NC', conference: 'acc', primary_color: '#7BAFD4', secondary_color: '#13294B', fan_size_rank: 55 },
  ...
  { slug: 'nc-state', name: 'NC State Wolfpack', short_name: 'NC State', mascot: 'Wolfpack', nickname: 'Pack', city: 'Raleigh', state: 'NC', conference: 'acc', primary_color: '#CC0000', secondary_color: '#FFFFFF', fan_size_rank: 57 },
  ...
  { slug: 'syracuse', name: 'Syracuse Orange', short_name: 'Syracuse', mascot: 'Orange', nickname: 'Cuse', city: 'Syracuse', state: 'NY', conference: 'acc', primary_color: '#F76900', secondary_color: '#002D72', fan_size_rank: 61 },
  ...
  { slug: 'virginia', name: 'Virginia Cavaliers', short_name: 'Virginia', mascot: 'Cavaliers', nickname: 'Hoos', city: 'Charlottesville', state: 'VA', conference: 'acc', primary_color: '#232D4B', secondary_color: '#F84C1E', fan_size_rank: 63 },
  { slug: 'boston-college', name: 'Boston College Eagles', short_name: 'Boston College', mascot: 'Eagles', nickname: 'Eagles', city: 'Chestnut Hill', state: 'MA', conference: 'acc', primary_color: '#98002E', secondary_color: '#BC9B6A', fan_size_rank: 64 },
  ...
  { slug: 'stanford', name: 'Stanford Cardinal', short_name: 'Stanford', mascot: 'Cardinal', nickname: 'Cardinal', city: 'Stanford', state: 'CA', conference: 'acc', primary_color: '#8C1515', secondary_color: '#FFFFFF', fan_size_rank: 66 },
  ...
  { slug: 'east-carolina', name: 'East Carolina Pirates', short_name: 'East Carolina', mascot: 'Pirates', nickname: 'Pirates', city: 'Greenville', state: 'NC', conference: 'american', primary_color: '#592A8A', secondary_color: '#FFC72C', fan_size_rank: 73 },
  ...
  { slug: 'charlotte', name: 'Charlotte 49ers', short_name: 'Charlotte', mascot: '49ers', nickname: 'Niners', city: 'Charlotte', state: 'NC', conference: 'american', primary_color: '#005035', secondary_color: '#B3A369', fan_size_rank: 76 },
  ...
  { slug: 'rice', name: 'Rice Owls', short_name: 'Rice', mascot: 'Owls', nickname: 'Owls', city: 'Houston', state: 'TX', conference: 'american', primary_color: '#00205B', secondary_color: '#5E6062', fan_size_rank: 78 },
  ...
  { slug: 'utsa', name: 'UTSA Roadrunners', short_name: 'UTSA', mascot: 'Roadrunners', nickname: 'Runners', city: 'San Antonio', state: 'TX', conference: 'american', primary_color: '#0C2340', secondary_color: '#F15A22', fan_size_rank: 80 },
  ...
  { slug: 'san-diego-state', name: 'San Diego State Aztecs', short_name: 'SDSU', mascot: 'Aztecs', nickname: 'Aztecs', city: 'San Diego', state: 'CA', conference: 'mountain-west', primary_color: '#A6192E', secondary_color: '#000000', fan_size_rank: 82 },
  { slug: 'fresno-state', name: 'Fresno State Bulldogs', short_name: 'Fresno State', mascot: 'Bulldogs', nickname: 'Bulldogs', city: 'Fresno', state: 'CA', conference: 'mountain-west', primary_color: '#DB0032', secondary_color: '#002E6D', fan_size_rank: 83 },
  ...
  { slug: 'unlv', name: 'UNLV Rebels', short_name: 'UNLV', mascot: 'Rebels', nickname: 'Rebels', city: 'Las Vegas', state: 'NV', conference: 'mountain-west', primary_color: '#CF0A2C', secondary_color: '#000000', fan_size_rank: 85 },
  { slug: 'air-force', name: 'Air Force Falcons', short_name: 'Air Force', mascot: 'Falcons', nickname: 'Falcons', city: 'Colorado Springs', state: 'CO', conference: 'mountain-west', primary_color: '#003087', secondary_color: '#8F8F8C', fan_size_rank: 86 },
  ...
  { slug: 'hawaii', name: 'Hawaii Rainbow Warriors', short_name: 'Hawaii', mascot: 'Rainbow Warriors', nickname: 'Warriors', city: 'Honolulu', state: 'HI', conference: 'mountain-west', primary_color: '#024731', secondary_color: '#000000', fan_size_rank: 88 },
  ...
  { slug: 'utah-state', name: 'Utah State Aggies', short_name: 'Utah State', mascot: 'Aggies', nickname: 'Aggies', city: 'Logan', state: 'UT', conference: 'mountain-west', primary_color: '#0F2439', secondary_color: '#FFFFFF', fan_size_rank: 92 },

  // ═══════════════════════════════════════════
  // SUN BELT
  // ═══════════════════════════════════════════
  { slug: 'app-state', name: 'Appalachian State Mountaineers', short_name: 'App State', mascot: 'Mountaineers', nickname: 'Mountaineers', city: 'Boone', state: 'NC', conference: 'sun-belt', primary_color: '#222222', secondary_color: '#FFCC00', fan_size_rank: 93 },
  { slug: 'james-madison', name: 'James Madison Dukes', short_name: 'James Madison', mascot: 'Dukes', nickname: 'Dukes', city: 'Harrisonburg', state: 'VA', conference: 'sun-belt', primary_color: '#450084', secondary_color: '#CBB677', fan_size_rank: 94 },
  { slug: 'marshall', name: 'Marshall Thundering Herd', short_name: 'Marshall', mascot: 'Thundering Herd', nickname: 'Herd', city: 'Huntington', state: 'WV', conference: 'sun-belt', primary_color: '#00B140', secondary_color: '#FFFFFF', fan_size_rank: 95 },
  { slug: 'louisiana', name: 'Louisiana Ragin\' Cajuns', short_name: 'Louisiana', mascot: 'Ragin\' Cajuns', nickname: 'Cajuns', city: 'Lafayette', state: 'LA', conference: 'sun-belt', primary_color: '#CE181E', secondary_color: '#0A0203', fan_size_rank: 96 },
  { slug: 'southern-miss', name: 'Southern Miss Golden Eagles', short_name: 'Southern Miss', mascot: 'Golden Eagles', nickname: 'Eagles', city: 'Hattiesburg', state: 'MS', conference: 'sun-belt', primary_color: '#000000', secondary_color: '#FFB81C', fan_size_rank: 97 },
  { slug: 'troy', name: 'Troy Trojans', short_name: 'Troy', mascot: 'Trojans', nickname: 'Trojans', city: 'Troy', state: 'AL', conference: 'sun-belt', primary_color: '#8B2332', secondary_color: '#000000', fan_size_rank: 98 },
  { slug: 'georgia-southern', name: 'Georgia Southern Eagles', short_name: 'Georgia Southern', mascot: 'Eagles', nickname: 'Eagles', city: 'Statesboro', state: 'GA', conference: 'sun-belt', primary_color: '#011E41', secondary_color: '#87714D', fan_size_rank: 99 },
  { slug: 'old-dominion', name: 'Old Dominion Monarchs', short_name: 'Old Dominion', mascot: 'Monarchs', nickname: 'Monarchs', city: 'Norfolk', state: 'VA', conference: 'sun-belt', primary_color: '#003057', secondary_color: '#8F9295', fan_size_rank: 100 },
  ...
  { slug: 'south-alabama', name: 'South Alabama Jaguars', short_name: 'South Alabama', mascot: 'Jaguars', nickname: 'Jags', city: 'Mobile', state: 'AL', conference: 'sun-belt', primary_color: '#003E7E', secondary_color: '#CC0000', fan_size_rank: 103 },
  { slug: 'texas-state', name: 'Texas State Bobcats', short_name: 'Texas State', mascot: 'Bobcats', nickname: 'Bobcats', city: 'San Marcos', state: 'TX', conference: 'sun-belt', primary_color: '#501214', secondary_color: '#8E794A', fan_size_rank: 104 },
  { slug: 'louisiana-monroe', name: 'Louisiana Monroe Warhawks', short_name: 'ULM', mascot: 'Warhawks', nickname: 'Warhawks', city: 'Monroe', state: 'LA', conference: 'sun-belt', primary_color: '#840029', secondary_color: '#BEA368', fan_size_rank: 105 },

  // ═══════════════════════════════════════════
  // MAC
  // ═══════════════════════════════════════════
  { slug: 'toledo', name: 'Toledo Rockets', short_name: 'Toledo', mascot: 'Rockets', nickname: 'Rockets', city: 'Toledo', state: 'OH', conference: 'mac', primary_color: '#003C72', secondary_color: '#FFD200', fan_size_rank: 106 },
  ...
  { slug: 'western-michigan', name: 'Western Michigan Broncos', short_name: 'Western Michigan', mascot: 'Broncos', nickname: 'Broncos', city: 'Kalamazoo', state: 'MI', conference: 'mac', primary_color: '#6C4023', secondary_color: '#B5985A', fan_size_rank: 108 },
  ...
  { slug: 'bowling-green', name: 'Bowling Green Falcons', short_name: 'Bowling Green', mascot: 'Falcons', nickname: 'Falcons', city: 'Bowling Green', state: 'OH', conference: 'mac', primary_color: '#4F2C1D', secondary_color: '#FF7300', fan_size_rank: 114 },
  ...
  { slug: 'kent-state', name: 'Kent State Golden Flashes', short_name: 'Kent State', mascot: 'Golden Flashes', nickname: 'Flashes', city: 'Kent', state: 'OH', conference: 'mac', primary_color: '#002664', secondary_color: '#EAAB00', fan_size_rank: 116 },
  ...
  // CONFERENCE USA
  // ═══════════════════════════════════════════
  { slug: 'western-kentucky', name: 'Western Kentucky Hilltoppers', short_name: 'WKU', mascot: 'Hilltoppers', nickname: 'Toppers', city: 'Bowling Green', state: 'KY', conference: 'cusa', primary_color: '#B01E24', secondary_color: '#FFFFFF', fan_size_rank: 118 },
  { slug: 'sam-houston', name: 'Sam Houston Bearkats', short_name: 'Sam Houston', mascot: 'Bearkats', nickname: 'Kats', city: 'Huntsville', state: 'TX', conference: 'cusa', primary_color: '#F58025', secondary_color: '#FFFFFF', fan_size_rank: 119 },
  ...
  { slug: 'louisiana-tech', name: 'Louisiana Tech Bulldogs', short_name: 'Louisiana Tech', mascot: 'Bulldogs', nickname: 'Bulldogs', city: 'Ruston', state: 'LA', conference: 'cusa', primary_color: '#002F8B', secondary_color: '#CF0A2C', fan_size_rank: 121 },
  { slug: 'jacksonville-state', name: 'Jacksonville State Gamecocks', short_name: 'Jax State', mascot: 'Gamecocks', nickname: 'Gamecocks', city: 'Jacksonville', state: 'AL', conference: 'cusa', primary_color: '#CC0000', secondary_color: '#FFFFFF', fan_size_rank: 122 },
  ...
  { slug: 'new-mexico-state', name: 'New Mexico State Aggies', short_name: 'NMSU', mascot: 'Aggies', nickname: 'Aggies', city: 'Las Cruces', state: 'NM', conference: 'cusa', primary_color: '#891216', secondary_color: '#FFFFFF', fan_size_rank: 125 },

  // ═══════════════════════════════════════════
  // INDEPENDENTS (remaining)
  // ═══════════════════════════════════════════
  { slug: 'liberty', name: 'Liberty Flames', short_name: 'Liberty', mascot: 'Flames', nickname: 'Flames', city: 'Lynchburg', state: 'VA', conference: 'independent', primary_color: '#002D62', secondary_color: '#C41230', fan_size_rank: 126 },
  { slug: 'connecticut', name: 'Connecticut Huskies', short_name: 'UConn', mascot: 'Huskies', nickname: 'Huskies', city: 'Storrs', state: 'CT', conference: 'independent', primary_color: '#000E2F', secondary_color: '#FFFFFF', fan_size_rank: 127 },
  { slug: 'umass', name: 'UMass Minutemen', short_name: 'UMass', mascot: 'Minutemen', nickname: 'Minutemen', city: 'Amherst', state: 'MA', conference: 'independent', primary_color: '#881C1C', secondary_color: '#000000', fan_size_rank: 128 },
  // Army and Navy already covered; the remaining independents
  { slug: 'army', name: 'Army Black Knights', short_name: 'Army', mascot: 'Black Knights', nickname: 'Knights', city: 'West Point', state: 'NY', conference: 'independent', primary_color: '#000000', secondary_color: '#D3BC8D', fan_size_rank: 129 },
